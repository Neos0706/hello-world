<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="supportShow=!supportShow">
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="shopShow=!shopShow"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet"  v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" v-for="(support,index) in shopInfo.supports" :key="index" :class="supportClasses[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-cover" @click="supportShow=!supportShow"></div>
      </div>
    </transition>
  </div>
</template>
